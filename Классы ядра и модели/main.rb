...
st1_s = Student_short.initialize_from_string(id:3, string:"first_name: Имя;second_name: Фамилия;third_name: Отчество;Telephone:8 999 999 99 99; Email: abc@mail.ru; git:VasiliyOs; telegram:@Jackobs22" )
puts st1_s.to_s
st2_s = Student_short.student_in_short_student(st2)
puts st2_s.to_s
st2_s = Student_short.student_in_short_student(st1)
puts st2_s.to_s
